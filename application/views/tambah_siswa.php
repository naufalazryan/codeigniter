<center>
  <div class="w-full max-w-xs">
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" href="<?php echo site_url('siswa/save') ?>" method="post">
      <div class="mb-4">
...
<!--  <div class="bg-zinc-300 m-10 rounded-lg">
        ...
        <hr class="bg-black">
            ...
            <form action="<?php echo site_url('siswa/save') ?>" method="post" class="p-5">
